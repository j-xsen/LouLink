...
export const AVATAR_BLOB_SHAPES: Record<string, { viewBox: string; d: string }> = {
  ...
  "2": { viewBox: "0 0 1013.79 568",    d: "M476.64,61.82C423.88,81.12-19.09,243.23.64,373.82c26.03,172.28,859.35,302.51,992,64,66.78-120.07-32.37-354.52-188-420-94.72-39.85-187.4-7.45-328,44Z" },
  "5": { viewBox: "0 0 714.47 623.03",  d: "M101.43,85.92c-138.7,119.13-134.7,326.99,9.24,448,143.17,120.36,380.16,117.26,511.33,0,153.18-136.95,106.77-380.18-70.85-482.67C418.96-25.02,222.79-18.32,101.43,85.92Z" },
  ...
  "7": { viewBox: "0 0 955.97 637.3",   d: "M61.07,314.43C28.02,265.74-14.83,200.75,5.07,138.43,49.1.53,369.9-29.15,602.41,26.43c115.47,27.6,267.76,64.01,328,197.33,50.38,111.49,24.44,264.35-61.33,344-180.62,167.72-627.87,12.01-808-253.33Z" },
};
